...
public class AddFriendFragment extends Fragment{
	...
	private void setAdapterForACTV() {
		//populateUsersList();
		mAdapter = new ArrayAdapter(getActivity(), android.R.layout.simple_list_item_1, UserInfo.getUsersNames(usersList));
		    ...
		    public void onClick(View v) {
		    	...
		    	if (!UserInfo.containsUser(usersList, friendName.toString())) {
			    	...
			    	if (UserInfo.containsUser(friendsList, friendName.toString())) {
			    		...
			    		friendsList.add(new UserInfo(friendName.toString(), new LatLng(0,0), (long) 0));			    		
			    		// Add friend to the friends list from MainActivity in order to make it
			    		// accesible for any fragment
			    		MainActivity.addToFriendsList(new UserInfo(friendName.toString(), new LatLng(0,0), (long) 0));
